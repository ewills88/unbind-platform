      ...
      <main className="flex-1 overflow-auto">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          {filteredCases.length === 0 ? (
            ...
            <div className="bg-white dark:bg-[#111827] rounded-lg border border-gray-200 dark:border-[#1f2937] divide-y divide-gray-200 dark:divide-[#1f2937]">
              {filteredCases.map((c) => (
                <button
                  key={c.id}
                  type="button"
                  onClick={() => router.push(`/dashboard/cases/${c.id}`)}
                  className="w-full text-left p-4 hover:bg-gray-50 dark:hover:bg-[#1f2937] transition-colors cursor-pointer focus:outline-none focus:bg-blue-50"
                >
