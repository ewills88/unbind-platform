    ...
    <div className="max-w-5xl mx-auto px-6 py-8">
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-gray-600 dark:text-gray-300 mt-1">Configure your firm profile and preferences</p>
        </div>
        {saved && (
        ...
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <input type="text" value={settings.profile.business_name || ''} onChange={e => updateField('profile', 'business_name', e.target.value)}
                  className="w-full px-3 py-2 border border-gray-300 dark:border-[#374151] rounded-lg text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500" />
              </div>
              <div>
                <label className="block text-sm font-medium text-gray-700 dark:text-gray-200 mb-1">Legal Name</label>
                <input type="text" value={settings.profile.legal_name || ''} onChange={e => updateField('profile', 'legal_name', e.target.value)}
                  className="w-full px-3 py-2 border border-gray-300 dark:border-[#374151] rounded-lg text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500" />
              </div>
              <div>
                <label className="block text-sm font-medium text-gray-700 dark:text-gray-200 mb-1">Bar Number</label>
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 dark:text-gray-200 mb-1">Primary Email</label>
                <input type="email" value={settings.profile.primary_email || ''} onChange={e => updateField('profile', 'primary_email', e.target.value)}
                  className="w-full px-3 py-2 border border-gray-300 dark:border-[#374151] rounded-lg text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500" />
              </div>
              <div>
                <label className="block text-sm font-medium text-gray-700 dark:text-gray-200 mb-1">Primary Phone</label>
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 dark:text-gray-200 mb-1">Fax</label>
          ...
          <div className="bg-white dark:bg-[#111827] border border-gray-200 dark:border-[#1f2937] rounded-lg p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="md:col-span-2">
                <label className="block text-sm font-medium text-gray-700 dark:text-gray-200 mb-1">Address Line 1</label>
                <input type="text" value={settings.profile.address_line1 || ''} onChange={e => updateField('profile', 'address_line1', e.target.value)}
                  className="w-full px-3 py-2 border border-gray-300 dark:border-[#374151] rounded-lg text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500" />
              </div>
              <div className="md:col-span-2">
                <label className="block text-sm font-medium text-gray-700 dark:text-gray-200 mb-1">Address Line 2</label>
          ...
          <div className="bg-white dark:bg-[#111827] border border-gray-200 dark:border-[#1f2937] rounded-lg p-6">
            <div className="flex items-center gap-2 mb-4">
              ...
              <h3 className="font-semibold text-gray-900 dark:text-white">Localization & Branding</h3>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 dark:text-gray-200 mb-1">Date Format</label>
              ...
              <div>
                ...
                <div className="flex items-center gap-2">
                  <input type="color" value={settings.profile.primary_color} onChange={e => updateField('profile', 'primary_color', e.target.value)}
                    className="w-10 h-10 rounded border border-gray-300 dark:border-[#374151] cursor-pointer" />
                  <input type="text" value={settings.profile.primary_color} onChange={e => updateField('profile', 'primary_color', e.target.value)}
                    className="flex-1 px-3 py-2 border border-gray-300 dark:border-[#374151] rounded-lg text-sm" />
                </div>
              </div>
              <div>
                <label className="block text-sm font-medium text-gray-700 dark:text-gray-200 mb-1">Time Format</label>
      ...
      {tab === 'billing' && (
        <div className="space-y-6">
          <div className="bg-white dark:bg-[#111827] border border-gray-200 dark:border-[#1f2937] rounded-lg p-6">
            <h3 className="font-semibold text-gray-900 dark:text-white mb-4">Billing Defaults</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <label className="block text-sm font-medium text-gray-700 dark:text-gray-200 mb-1">Default Hourly Rate ($)</label>
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 dark:text-gray-200 mb-1">Billing Increment</label>
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 dark:text-gray-200 mb-1">Invoice Due Days</label>
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 dark:text-gray-200 mb-1">Invoice Prefix</label>
          ...
          <div className="bg-white dark:bg-[#111827] border border-gray-200 dark:border-[#1f2937] rounded-lg p-6">
            <h3 className="font-semibold text-gray-900 dark:text-white mb-4">Payment & Trust</h3>
              ...
              {[
                ...
                <label key={item.field} className="flex items-center gap-3 cursor-pointer">
                  <input type="checkbox"
                    ...
                    className="w-4 h-4 text-blue-600 border-gray-300 dark:border-[#374151] rounded focus:ring-blue-500" />
          ...
          <div className="bg-white dark:bg-[#111827] border border-gray-200 dark:border-[#1f2937] rounded-lg p-6">
            <h3 className="font-semibold text-gray-900 dark:text-white mb-4">Invoice Text</h3>
            <div className="space-y-4">
              <div>
                <label className="block text-sm font-medium text-gray-700 dark:text-gray-200 mb-1">Payment Instructions</label>
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 dark:text-gray-200 mb-1">Invoice Footer</label>
      ...
      {tab === 'cases' && (
        <div className="space-y-6">
          <div className="bg-white dark:bg-[#111827] border border-gray-200 dark:border-[#1f2937] rounded-lg p-6">
            <h3 className="font-semibold text-gray-900 dark:text-white mb-4">Case Numbering</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <label className="block text-sm font-medium text-gray-700 dark:text-gray-200 mb-1">Prefix</label>
          ...
          <div className="bg-white dark:bg-[#111827] border border-gray-200 dark:border-[#1f2937] rounded-lg p-6">
            <h3 className="font-semibold text-gray-900 dark:text-white mb-4">Case Defaults</h3>
            <div className="space-y-3">
              {[
              ...
              {settings.cases.require_retainer && (
                <div className="ml-7">
                  <label className="block text-sm font-medium text-gray-700 dark:text-gray-200 mb-1">Default Retainer Amount ($)</label>
                  <input type="number" value={settings.cases.default_retainer_amount || ''} onChange={e => updateField('cases', 'default_retainer_amount', parseFloat(e.target.value) || null)}
                    className="w-48 px-3 py-2 border border-gray-300 dark:border-[#374151] rounded-lg text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500" />
                </div>
              )}
            </div>
          </div>
        ...
        <div className="space-y-6">
          <div className="bg-white dark:bg-[#111827] border border-gray-200 dark:border-[#1f2937] rounded-lg p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 dark:text-gray-200 mb-1">From Address</label>
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 dark:text-gray-200 mb-1">Reply-To</label>
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 dark:text-gray-200 mb-1">Appointment Reminder (hours before)</label>
          ...
          <div className="bg-white dark:bg-[#111827] border border-gray-200 dark:border-[#1f2937] rounded-lg p-6">
            <h3 className="font-semibold text-gray-900 dark:text-white mb-4">Notification Toggles</h3>
            <div className="space-y-3">
              {[
